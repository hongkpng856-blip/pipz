"""Use PixelLab API to generate cat PLAY animation"""
...
payload = {
    "description": "cute orange tabby cat, jumping up, paws stretching out, playful, tail up, happy, energetic",
    "action": "play",
    "view": "side",
    "direction": "east",
...
print("Calling animate-with-text for PLAY...")
resp = requests.post(
...
if 'images' in data:
    ...
    for i, img in enumerate(data['images']):
        ...
        if b64.startswith('data:'):
            b64 = b64.split(',', 1)[1]
        path = rf'C:\Users\claw\Desktop\Pipz\scripts\cat_play_frame_{i}.png'
