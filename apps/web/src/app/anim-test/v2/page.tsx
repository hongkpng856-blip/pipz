...
// ── 12 diverse seeds covering different species ──
const DEMO_SEEDS = [1, 42, 99, 777, 2024, 3301, 5555, 8888, 12345, 25000, 50000, 99999]
...
// Speed per animation type
const ANIM_SPEED: Record<string, number> = { walk: 150, idle: 180, play: 120 }
...
function PetPlayer({ seed }: { seed: number }) {
  ...
  useEffect(() => {
    ...
    let f = 0, last = 0
    const speed = ANIM_SPEED[animType]
  ...
  return (
    <div style={{ background: '#141b2d', borderRadius: 16, padding: 12, textAlign: 'center' }}>
  ...
  return (
    <>
      ...
      <div style={{ maxWidth: 800, margin: '0 auto' }}>
        ...
        {/* ── All 12 Procedural Pets ── */}
        <div style={{ marginBottom: 24 }}>
          <div style={{ fontSize: 16, fontWeight: 700, color: '#f0f4f8', marginBottom: 8 }}>
            🎲 12 Procedural Pets — Walk / Idle / Play
          </div>
          <p style={{ color: '#5a6d85', fontSize: 12, marginBottom: 12 }}>
            Tap 🚶 😴 🎉 to switch animation · All generated procedurally from pixel grid
          </p>
          <div style={{
            display: 'grid',
